 ...
 */
package laboratoriooperadores60066;

/**
 *
 * @author Rafael Moreno
 */
public class LaboratorioOperadores60066 {
    ...
    public static void main(String[] args) {
        ...
        int byte1 = 51;
        int byte2 = 112;
        System.out.println("El byte 1 en binario: " + Integer.toBinaryString(byte1));
        System.out.println("El byte 2 en binario: " + Integer.toBinaryString(byte2));
        ...
        System.out.println("Desplazmiento sin signo 3 lugares a la " + "derecha: " + Integer.toBinaryString(byte1 >>> 3));
